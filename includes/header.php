...
<title>Services – Accuverse</title>

<!-- Fav Icon -->

<link rel="icon" href="assets/images/fav.webp" sizes="32x32">
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <header class="main-header">
                    ...
                    <div class="top-inner">
                        <div class="top-left">
                            <ul class="info clearfix">                               
                                <li><i class="icon-2"></i><a href="tel:971569856360">+971 56 985 6360</a></li>
                                <li><i class="icon-3"></i><a href="mailto:info@accuverse.ae">info@accuverse.ae</a></li>
                            </ul>
                        </div>
                        <div class="top-right">
                            <div class="login text-white">Follow Us </div>
                            <ul class="social-links clearfix">
                                <li><a href="https://www.facebook.com/accuverse.uae" target="_blank" rel="nofollow"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="https://api.whatsapp.com/send/?phone=%2B971569856360&text&type=phone_number&app_absent=0" target="_blank" rel="nofollow"><i class="fab fa-whatsapp"></i></a></li>
                                <li><a href="https://www.instagram.com/accuverseuae/"><i class="fab fa-instagram" target="_blank" rel="nofollow"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="header-lower">
                <div class="auto-container">
                    <div class="outer-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="assets/images/accuverse_logo.webp" alt=""></a></figure>
                        </div>
                                ...
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="services.php">Services</a>
                                            <ul>
                                                <li><a href="services-details.php">Our Services 1</a></li>
                        ...
                        <ul class="menu-right-content">
                            ...
                            <li class="btn-box">
                                <a href="consulting.php">Free Consulting</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="assets/images/accuverse_logo.webp" alt="" title=""></a></div>
                <div class="menu-outer"><!--Here Menu Will Come Automatically Via Javascript / Same Menu as in Header--></div>
                <div class="contact-info">
                    <h4>Contact Info</h4>
                    <ul>
                        <li>Office 1209, Burlington Tower, Business Bay, Dubai, UAE</li>
                        <li><a href="tel:+971569856360">+971 56 985 6360</a></li>
                        <li><a href="mailto:info@accuverse.ae">info@accuverse.ae</a></li>
                    </ul>
                </div>
